			...
			<form id="contentUpdateForm" method="post">
				...
				<table class="easyui-panel form-table">
				   <tr>
						...
						<td class="form-table-td-right">
								<input class="easyui-validatebox" type="text" name="menuPos" data-options="required:true,validType:['length[0,20]']" />
						</td>
				    </tr>
				   <tr>
						<td class="form-table-td-left">
...
var contentUpdatePage  = {
	initFormData:function(){
		var url = "${contextPath}/platform/menu/load";
		url += "/${menuid}";
	...
	submitForm : function (){
		...
		$.post("${contextPath}/platform/menu/update",$("#contentUpdateForm").serialize(), function(data){
			if(data.status == 200){
